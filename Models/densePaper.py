...
class DenseRegressorPaper(nn.Module):
    def __init__(self, input_dim, output_dim, is_cuda = False):
        ...
        self.relu1 = nn.ReLU()
        self.relu2 = nn.ReLU()
        self.fc1 = PaperLayers.LinearGroupNJ(input_dim, 300, is_cuda)
        self.fc2 = PaperLayers.LinearGroupNJ(300, 100, is_cuda)
        self.fc3 = PaperLayers.LinearGroupNJ(100, output_dim, is_cuda)
